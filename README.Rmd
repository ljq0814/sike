...
`sike` implements Sliced Inverse Kendall's tau Estimation (SIKE), a sufficient 
dimension reduction method designed for heavy-tailed elliptically distributed 
data. This method is based on the Kendall's tau matrix and is applicable to 
heavy-tailed distributions. A refinement algorithm is also included to improve 
...
## Reference
Li, J., He, S., & Chen, X. (2026). High-dimensional Sliced Inverse Kendall's tau Estimation for Heavy-tailed Data. *Journal of Business & Economic Statistics*, online published. https://doi.org/10.1080/07350015.2026.2707219